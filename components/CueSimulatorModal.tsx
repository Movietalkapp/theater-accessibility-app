// 3. Skapa Simulator UI komponent - skapa fil: src/components/CueSimulatorModal.tsx
    ...
    return (
      ...
      >
        <View style={styles.cueButtonHeader}>
          ...
          <Text style={styles.cueActionCount}>{cue.actions.length} action{cue.actions.length !== 1 ? 's' : ''}</Text>
        </View>
